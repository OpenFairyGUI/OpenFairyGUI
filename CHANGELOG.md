...
- backend, mcp: Add revision-bound, isolated resource/component/node property queries with fixed projections, explicit response budgets and selector errors; capability schema version is 5.
