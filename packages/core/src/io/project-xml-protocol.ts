...
const TEXT_INPUT_NODE = defineNode(mergeAttrs(XY_SIZE_ATTRS, RESTRICT_SIZE_ATTRS, GROUP_REF_ATTRS, VISIBLE_ATTRS, TEXT_PANEL_ATTRS, TEXT_INPUT_PANEL_ATTRS));

const RICH_TEXT_NODE = defineNode(
	mergeAttrs(XY_SIZE_ATTRS, GROUP_REF_ATTRS, VISIBLE_ATTRS, TEXT_PANEL_ATTRS, RICH_TEXT_PANEL_ATTRS),
	mergeChildren(WITH_RELATION_CHILDREN, WITH_GEAR_CHILDREN),
);
