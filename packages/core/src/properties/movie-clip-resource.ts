...
export class MovieClipResource extends ExtensibleProperty<IMovieClipResource> {
	...
	public setInterval(v: number): this {
		return this.set('interval', v);
	}

	public getSwing(): boolean {
		return this.get('swing');
	}
	public setSwing(v: boolean): this {
		return this.set('swing', v);
	}

	public getRepeatDelay(): number {
		return this.get('repeatDelay');
	}
	public setRepeatDelay(v: number): this {
	...
	public addFrame(frame: MovieFrame): this {
		return this.addRef('frames', frame);
	}
	public removeFrame(frame: MovieFrame): this {
		return this.removeRef('frames', frame);
	}
	public listFrames(): MovieFrame[] {
