...
> extends ExtensibleProperty<TProps> {
	...
	public setBlendMode(v: string): this {
	...
	public addGear(gear: Gear): this {
		return this.addRef('gears' as never, gear as never);
	}
	public removeGear(gear: Gear): this {
		return this.removeRef('gears' as never, gear as never);
	}
	public listGears(): Gear[] {
		return this.listRefs('gears' as never) as unknown as Gear[];
	}
}
