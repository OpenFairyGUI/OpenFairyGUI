...
export class GLoader extends GObject<IGLoader, PropertyType.G_LOADER> {
	...
	public setFill(v: number): this {
		return this.set('fill', v);
	}

	public getShrinkOnly(): boolean {
		return this.get('shrinkOnly');
	}
	public setShrinkOnly(v: boolean): this {
	...
	public setAutoSize(v: boolean): this {
		return this.set('autoSize', v);
	}

	public getUseResize(): boolean {
		return this.get('useResize');
	}
	public setUseResize(v: boolean): this {
		return this.set('useResize', v);
	}

	public getShowErrorSign(): boolean {
		return this.get('showErrorSign');
	}
	public setShowErrorSign(v: boolean): this {
	...
	public getClearOnPublish(): boolean {
		return this.get('clearOnPublish');
	}
	public setClearOnPublish(v: boolean): this {
