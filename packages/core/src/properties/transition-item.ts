...
export class TransitionItem extends Property<ITransitionItem> {
	...
	public setTargetId(v: string): this {
	...
	public setDuration(v: number): this {
		return this.set('duration', v);
	}

	public getStartValue(): unknown[] {
		return this.get('startValue' as never) as unknown[];
	}
	public setStartValue(v: unknown[]): this {
		return this.set('startValue' as never, v as never);
	}

	public getEndValue(): unknown[] {
		return this.get('endValue' as never) as unknown[];
	}
	public setEndValue(v: unknown[]): this {
		return this.set('endValue' as never, v as never);
	}
	...
	public setRepeat(v: number): this {
		return this.set('repeat', v);
	}

	public getYoyo(): boolean {
		return this.get('yoyo');
	}
	public setYoyo(v: boolean): this {
	...
	public setEndLabel(v: string): this {
