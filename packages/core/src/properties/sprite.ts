...
export class Sprite extends ExtensibleProperty<ISprite> {
	...
	public setItemId(v: string): this {
		return this.set('itemId', v);
	}

	public getAtlas(): Atlas | null {
		return this.getRef('atlas' as never) as Atlas | null;
	}
	public setAtlas(atlas: Atlas | null): this {
		return this.setRef('atlas' as never, atlas as never);
	}
	...
	public getRotated(): boolean {
		return this.get('rotated');
	}
	public setRotated(v: boolean): this {
	...
	public setOffsetX(v: number): this {
	...
	public setOffsetY(v: number): this {
	...
	public setOriginalWidth(v: number): this {
	...
	public setOriginalHeight(v: number): this {
