...
export class GGraph extends GObject<IGGraph, PropertyType.G_GRAPH> {
	...
	public getGraphType(): number {
		return this.get('graphType');
	}
	public setGraphType(v: number): this {
	...
	public setLineSize(v: number): this {
	...
	public setLineColor(v: string): this {
	...
	public setFillColor(v: string): this {
		return this.set('fillColor', v);
	}

	public getCornerRadius(): [number, number, number, number] | null {
		return this.get('cornerRadius');
	}
	public setCornerRadius(v: [number, number, number, number] | null): this {
		return this.set('cornerRadius', v);
	}

	public getPoints(): number[] | null {
		return this.get('points');
	}
	public setPoints(v: number[] | null): this {
	...
	public setStartAngle(v: number): this {
		return this.set('startAngle', v);
	}

	public getDistances(): number[] | null {
		return this.get('distances');
	}
	public setDistances(v: number[] | null): this {
