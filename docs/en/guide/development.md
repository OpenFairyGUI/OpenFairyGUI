...
| `pnpm eval:agent --runner reference` | Eight deterministic tarball/MCP task checks, including controller/transition editing and two safe stops; also run by `pack:check`, without calling a model |
