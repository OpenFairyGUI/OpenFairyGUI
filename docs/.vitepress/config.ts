						...
						'/guide/': [
							{
								...
								items: [
									...
									{ text: '可运行示例', link: '/guide/examples' },
									{ text: '契约与操作查询', link: '/guide/contracts' },
									{ text: '诊断与恢复', link: '/guide/diagnostics' },
									{ text: '安装版本文档', link: '/guide/installed-docs' },
									{ text: '仓库开发与验证', link: '/guide/development' },
									{ text: '开发任务指引', link: '/guide/task-recipes' },
									{ text: '真实 Agent 任务评测', link: '/guide/agent-evaluations' },
								],
							},
						],
						'/': [
							{
								...
								items: [
									...
									{
										text: 'Project XML DisplayList Tag 对齐',
										link: '/project-xml-displaylist-variants',
									},
						...
						'/en/guide/': [
							{
								...
								items: [
									...
									{ text: 'Runnable Examples', link: '/en/guide/examples' },
									{ text: 'Contracts and Operations', link: '/en/guide/contracts' },
									{ text: 'Diagnostics and Recovery', link: '/en/guide/diagnostics' },
									{ text: 'Installed Documentation', link: '/en/guide/installed-docs' },
									{ text: 'Repository Development', link: '/en/guide/development' },
									{ text: 'Development Task Recipes', link: '/en/guide/task-recipes' },
									{ text: 'Real Agent Evaluations', link: '/en/guide/agent-evaluations' },
								],
							},
						],
						'/en/': [
							{
								...
								items: [
									...
									{
										text: 'Published Project Recovery Limits',
										link: '/en/published-project-restore-limitations',
									},
									{
										text: 'Project XML Attribute Protocol',
										link: '/en/project-xml-attribute-reference',
									},
									{
										text: 'Project XML DisplayList Tag Alignment',
										link: '/en/project-xml-displaylist-variants',
									},
									{
										text: 'FairyGUI Binary Package Format',
										link: '/en/fairygui-binary-package-format',
									},
								],
							},
						],
